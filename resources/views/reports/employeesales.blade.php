...
@section('page-header')
    <div class="main-parent">
        ...
        <div class="breadcrumb-header justify-content-between parent-heading">
            <div class="my-auto">
                <div class="d-flex">
                    <h4 class="content-title mb-0 my-auto">{{ __('report.employeeـsales') }}
            ...
            <div class="col-xl-12">
                <div class="card mg-b-20">
                    ...
                    <div class="card-header pb-0">
                        ...
                        <form
                            action="{{ url(Mcamara\LaravelLocalization\Facades\LaravelLocalization::getCurrentLocale() . '/' . ($page = 'employeeSalesSearch')) }}"
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4" id="start_at">
                                    ...
                                    <div class="input-group">
                                        ...
                                        </div><input class="form-control fc-datepicker parent-input" value="{{ $start_at ?? '' }}"
                                ...
                                <div class="col-lg-4 mg-t-20 mg-lg-t-0" id="type">
                                    ...
                                    <select class="form-control parent-input" name="productname" required>
                                    ...
                                    ?>
                                                        ...
                                                        <tr id="<?php echo $product['id']; ?>">
                                                            ...
                                                            <td data-target="numberofpice">
                                                                ...
                                                                $saleavt=$avt->AVT;
                                                                ?>
                                                                {{ round(($product->Price-$product->discount) + (($product->Price-$product->discount)*$saleavt),2) }}</td>
                                                            ...
                                                            <td> <a style="color: #23395D" class="dropdown-item"
                                                                    href="showInvoiceRecent/{{ $product->id }}"><i style="fill:#072c3c !important"
                            ...
                            @if (isset($Invoices))
                                <div class="d-flex justify-content-center mb-3">
                                    ...
                                    <a style="background-color: #419BB2;font-size:17px" class="btn btn-success p-1"
                                        href="{{ url('/' . ($page = 'printReportemployeeSales') . '/' . $userId . '/' . $startat . '/' . $endat) }}">
                                        {{ __('home.print') }}
