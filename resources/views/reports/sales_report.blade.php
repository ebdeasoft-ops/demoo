...
@section('title')
{{ __('home.Historyـofـproductـsales') }}@stop
@endsection
@section('page-header')
<div class="main-parent">
    ...
    <div class="breadcrumb-header justify-content-between parent-heading">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">{{ __('home.Historyـofـproductـsales') }}
        ...
        <div class="col-xl-12">
            <div class="card mg-b-20">
                ...
                <div class="card-header pb-0">
                    ...
                    <form action="{{ url(Mcamara\LaravelLocalization\Facades\LaravelLocalization::getCurrentLocale() . '/' . ($page = 'salesReport')) }}" method="POST" role="search" autocomplete="off">
                        {{ csrf_field() }}
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 parent-label" id="end_at">
                            ...
                            <div class="col-lg-2 parent-label" id="end_at">
                                ...
                                <select class="form-control parent-input" name="branch" required>
                                    ...
                                    <option style="font-size: 15px" value="{{ $branch->id }}">
                                        {{ $branch->name }}
                                    </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col" id="type">
                                ...
                                <select class="form-control parent-input" name="pay" required>
                                    ...
                                    <option style="font-size: 15px" value="Shabka "> {{ __('report.shabka') }}
                                    </option>
                                    <option value="Bank_transfer"> {{ __('home.Bank_transfer') }} </option>

                                    <option style="font-size: 15px" value="Credit "> {{ __('report.credit') }}
                                    </option>
                ...
                <div style="border-radius: 10px" class="card-body mt-5">
                    <div class="table-striped">
                        ...
                        <table class="table table-hover table-bordered" id="example1" data-page-length='50' style=" text-align: center; width:95%">
                                    ...
                                    <tbody>
                                        ...
                                        <tr id="<?php echo $product['id']; ?>">
                                            ...
                                            <td> <a style="color: #23395D" class="dropdown-item" href="printInvoicesAllItemsWithReturned/{{ $product->id }}"><i style="fill:#072c3c !important" class=" fas fa-print"></i>&nbsp;&nbsp;
                                                    {{ __('home.show') }}
                                                </a></td>
                        ...
                        <div class="d-flex justify-content-center">
                            ...
                            <a style="background-color: #419BB2;font-size:17px" class="btn btn-success p-1" href="{{ url('/' . ($page = 'printInvoicesReport') . '/' . $pay[1] . '/' . $pay[0] . '/' . $startat . '/' . $endat. '/' . $customer_id) }}">
                                {{ __('home.print') }}
                            ...
                            &nbsp;
                             <a style="background-color: #419BB2;font-size:17px" class="btn btn-success p-1" href="{{ url('/' . ($page = 'printInvoicesReportdetails') . '/' . $pay[1] . '/' . $pay[0] . '/' . $startat . '/' . $endat. '/' . $customer_id) }}">
