...
@section('page-header')
    <div class="main-parent">
        ...
        <div class="breadcrumb-header justify-content-between parent-heading">
            <div class="my-auto">
                <div class="d-flex">
                    <h4 class="content-title mb-0 my-auto">{{ __('report.Delivery_notes') }}
            ...
            <div class="col-xl-12">
                <div class="card mg-b-20">
                    ...
                    <div class="card-header pb-0">
                        ...
                        <form
                            action="{{ url(Mcamara\LaravelLocalization\Facades\LaravelLocalization::getCurrentLocale() . '/' . ($page = 'Delivery_notes')) }}"
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3 mg-t-20 mg-lg-t-0" id="type">
                                    <p class="mg-b-10 parent-label"> {{ __('home.enterinvoicenumber') }} </p>
                                    <select class="form-control parent-input select2" name="UserId" required>
                                        ...
                                        @foreach (App\Models\resource_purchases::get() as $section)
                                            <option value="{{ $section->orderId }}"> {{ $section->orderId }}</option>
                                        @endforeach
                                    </select>
                                </div><!-- col-4 -->
                            ...
                            @if (isset($Invoices))
                                <div class="d-flex justify-content-center mb-2">
                                    ...
                                    <a style="background-color: #419BB2;font-size:17px" class="btn btn-success p-1"
                                        href="{{ url('/' . ($page = 'printDelivery_notes') . '/' . $supplierId . '/' . $startat . '/' . $endat) }}">
                                        {{ __('home.print') }}
