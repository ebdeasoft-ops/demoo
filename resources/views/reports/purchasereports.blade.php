...
@section('title')
    {{ __('home.purchasereports') }}@stop
@endsection
@section('page-header')
    <div class="main-parent">
        <!-- breadcrumb -->
        <div style="background-color: #FF4F1F !important;" class="breadcrumb-header justify-content-between parent-heading">
            <div class="my-auto">
                <div class="d-flex">
                    <h4 class="content-title mb-0 my-auto">{{ __('home.purchasereports') }}
            ...
            <div class="col-xl-12">
                <div class="card mg-b-20">
                    ...
                    <div class="card-header pb-0">
                        ...
                        <form
                            action="{{ url(Mcamara\LaravelLocalization\Facades\LaravelLocalization::getCurrentLocale() . '/' . ($page = 'purchasereports')) }}"
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3" id="start_at">
                                    ...
                                    <div class="input-group">
                                        ...
                                        </div><input class="parent-input form-control fc-datepicker" value="{{ $start_at ?? '' }}"
                                ...
                                <div class="col-lg-3" id="end_at">
                                    ...
                                    <div class="input-group">
                                        ...
                                        </div><input class="parent-input form-control fc-datepicker" name="end_at"
                                            value="{{ $end_at ?? '' }}" placeholder="YYYY-MM-DD" type="text" required>
                                    </div><!-- input-group -->
                                </div>

                                <div class="col-lg-6" id="type">
                                    <p class="mg-b-10 parent-label"> {{ __('home.searchbyproductname') }} </p>
                                    <select class="parent-input form-control select2" name="productname" required>
                                        <option style="font-size: 15px" value='-' selected>
                                            {{ $type ?? __('home.enterproductname') }}
                                        </option>

                                        @foreach (App\Models\products::get() as $section)
                                            <option value="{{ $section->id }}"> <label
                                                    dir=ltr>{{ $section->Product_Code }}</label> :
                                                {{ $section->product_name }} </option>
                                        @endforeach
                                    </select>
                                </div><!-- col-4 -->
    ...
    <thead>
                                ...
                                <div class="d-flex justify-content-center">
                                    ...
                                    <a style="background-color: #419BB2;font-size:17px" class="btn btn-success p-1"
                                        href="{{ url('/' . ($page = 'print_purchasereports') . '/' . $supplierId . '/' . $startat . '/' . $endat) }}">
                                        {{ __('home.print') }}
