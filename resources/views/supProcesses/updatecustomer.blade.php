...
<div class="main-parent">
    ...
    @endif   @if (session()->has('updateseccess'))
    <div class="alert alert-success alert-dismissible fade show" role="alert">
        <br>
        ...
        <div class="col-lg-12 col-md-12">
            <div style="border-end-end-radius: 10px;border-end-start-radius:10px" class="card pt-5">
                <div class="card-body pb-0">
                    <form action="{{ url(Mcamara\LaravelLocalization\Facades\LaravelLocalization::getCurrentLocale() . '/' . ($page = 'updatecustomer')) }}" method="post" enctype="multipart/form-data" autocomplete="off">
                        {{ csrf_field() }}
                        {{-- 1 --}}
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-4">
                                ...
                                <input  class="parent-input form-control" id="nameclient" name="nameclient" title="يرجي ادخال الكمية  " >
                            </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-lg-3">
                                ...
                                <input type="text" class="form-control parent-input" id="timeout_periodـinـdays" name="timeout_periodـinـdays" title="{{ __('supprocesses.timeout_periodـinـdays') }}" onkeyup="timeout_periodـinـdaysConvert()" required>
                            </div>
                            <div class="col-lg-3">
                                <label for="inputName" class="control-label parent-label"> {{ __('home.tax_number') }}</label>
                                <input type="text" class="form-control parent-input" id="TaxـNumber" name="TaxـNumber" onkeyup="TaxـNumberConvert()" title="{{ __('supprocesses.TaxـNumber') }}">
                            </div>
                            <div class="col-lg-3">
                                <label for="inputName" class="control-label parent-label">
                                    {{ __('supprocesses.credit_limit') }}</label>
                                <input type="text" class="form-control parent-input" id="credit_limit" name="credit_limit" onkeyup="credit_limitConvert()" title="{{ __('supprocesses.credit_limit') }}" required>
                            </div>
                              ...
                              <div class="col-lg-2">
                                 ...
                                 <div class="col-lg-2">
                                    ...
                                    <input type="text" class="form-control parent-input" id="postcode" name="postcode"
                                        title="{{ __('home.postcode') }}" required>
                           </div>
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        console.log(data);
                            ...
                            $("#credit_limit").val(data['Limit_credit']);
                            $("#TaxـNumber").val(data['tax_no']);
                            $("#timeout_periodـinـdays").val(data['grace_period_in_days']);
