        ...
        <div style="justify-content: space-between !important" class="breadcrumb-header parent-heading ">
            <div class="my-auto" style="width:100%">
                <div class="d-flex" style="width:100%">
                    ...
                    <div class="d-flex">
                        <h4 class="conte  nt-title mb-0 my-auto">{{ __('home.purchases') }}</h4>
                    ...
                    <div class="choose-product">
                        <a style="color:white;background-color: #23395D;border-radius:5px;font-size:11px;width:165px;padding:9px 6px"
                            ...
                            href="{{ url('/' . ($page = 'previousPurchasesInvoices')) }}">{{ __('home.previousPurchasesInvoices') }}
                    ...
                    &nbsp;
                             ...
                             @can('purchase return')
                                    <button  style="background-color: #23395D;" class="modal-effect btn btn-sm btn-info  button-eng" data-effect="effect-scale" data-toggle="modal" href="#updateinvoicebyidmodale" title="تحديد"><i
                                    class="las"> {{ __('home.invoice_purchase_update') }}</i>
                                        <svg style="width:16px !important" class="svg-icon-buttons" viewBox="0 0 20 20">
                    ...
                    <div class="choose-product">
                        <button style="background-color: #23395D;height:100%"
                            class="modal-effect btn btn-sm btn-info  button-eng" data-effect="effect-scale"
                            data-toggle="modal" href="#createsupplier" title="تحديد"><i style=" height: 50;font-weight:400 !important;
                                                     width: 65px;
                    ...
                    <form enctype="multipart/form-data" method="POST" role="search" name="form-name" id='formdata'
                        ...
                        <div style="border-radius: 10px" class="card p-3 my-3">
                            ...
                            <div class='row'>
                                ...
                                <div class="col-lg-2 mg-lg-t-10">
                                    <label for="inputName" class="form-label">{{ __('home.shearchbysuppliername') }}</label>
                            ...
                            <div class="col-lg-1  mg-lg-t-0" id="type">
                                ...
                                <div class="col-lg-1 mg-t-10" id="type">
                                    <label for="inputName" class="form-label">{{ __('users.branch') }} </label>
                                    <select class="form-control select2" id="branchs_id" name="branchs_id" onchange="syncValue()">
                                ...
                                <div class="col-lg-2 mg-t-10" id="type">
                                                                    <label for="inputName" class="form-label">{{ __('home.cost_center') }} </label>
                                ...
                                <div class="col-lg-1 mg-t-10">
                                    <label for="inputName" class="form-label">{{ __('home.shipping fee') }} </label>
                                    <input autocomplete="off" type="text" class="form-control parent-input " value=0
                                        id="shippingfee" name="shippingfee" title="يرجي ادخال رقم الجوال ">
                                </div>
                                    <input hidden autocomplete="off" v type="text" class="form-control parent-input "
                                        id="purchase_invoice_no" name="purchase_invoice_no" title="يرجي ادخال رقم الجوال "
                                        value=0>
                                ...
                                <div class="col-lg-1 mg-t-10">
                                    <label for="inputName"
                                        class="control-label parent-label">{{ __('home.enterinvoicenumber') }} </label>
                                    <input autocomplete="off" type="text" class="form-control parent-input "
                                        id="Purchase_invoice_number_supplier" name="Purchase_invoice_number_supplier" required
...
<div class="col-lg-4 mg-t-20 mg-lg-t-0">.</div>
   <div class="col-lg-4 mg-t-20 mg-lg-t-0">
                                <label for="inputName" class="control-label parent-label">
                                    {{ __('home.last_supplier_cost') }}</label>
