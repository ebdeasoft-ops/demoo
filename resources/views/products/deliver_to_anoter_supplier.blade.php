...
<div class="main-parent">
    ...
    <div class="breadcrumb-header justify-content-between parent-heading">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">{{ __('home.dlivery') }}</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">
                </span>
            </div>
        </div>
                    ...
                    <form action="{{ url(Mcamara\LaravelLocalization\Facades\LaravelLocalization::getCurrentLocale() . '/' . ($page = 'AddproductPriceToCustomer')) }}" method="POST" role="search" autocomplete="off">
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-lg-8 mg-t-20 mg-lg-t-0">
                                ...
                                <input type="text" class="form-control parent-input" id="notes" name="notes" title="  يرجي ادخال رقم المنتج  ">
                            </div>
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-lg-2 mg-t-20 mg-lg-t-0">
                             ...
                             <div class="col-lg-2 mg-t-20 mg-lg-t-0">
                                ...
                                <input autocomplete="off" type="text" class="form-control parent-input" id="priceWithTax" name="priceWithTax" onchange="changePriceWithTax()" onkeyup="convertToNumberPricewithTaxSale()" required>
                            </div>
                            <div class="col-lg-2 mg-t-20 mg-lg-t-0">
                                <label for="inputName" class="control-label parent-label">
                            ...
                            <div class="col-lg-1 mg-t-20 mg-lg-t-0">
                                ...
                                <input autocomplete="off" type="text" readonly value=0 class="form-control parent-input" id="lastpricecustomer" name="lastpricecustomer" onchange="changePriceWithTax()" onkeyup="convertToNumberPricewithTaxSale()" required>
                            </div>
                    ...
                    <div class="card-body pb-0">
                        <div class="table-responsive hoverable-table">
                            <table class="table text-center table-hover our-table" id="example" data-page-length='50'>
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th style="font-size: 15px;padding:8px" class="border-bottom-0">{{ __('home.productlocation') }}</th>
                                        ...
                                        <th style="font-size: 15px;padding:8px"   class="border-bottom-0">{{ __('home.totalafterdiscount') }}</th>
                            ...
                            <div class="table-responsive mg-t-30">
                                ...
                                <div class="d-flex justify-content-center">
                                    <form action="{{ url(Mcamara\LaravelLocalization\Facades\LaravelLocalization::getCurrentLocale() . '/' . ($page = 'print_delivery_to_anoter_supplier')) }}" method="POST" role="search" autocomplete="off">
                                        {{ csrf_field() }}
