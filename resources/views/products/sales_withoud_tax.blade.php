...
<div class="main-parent">
   ...
   <div class="d-flex">
                <h4 class="conte  nt-title mb-0 my-auto">{{ __('home.sel_product_withoud_tax') }}</h4>
...
<div class="col-lg-4 mg-t-20 mg-lg-t-0">.</div>
   <div class="col-lg-4 mg-t-20 mg-lg-t-0">
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-md-4"><label class="form-label">{{ __('home.the amount') }}</label><input
                                    readonly type="text" id="totalSum" name="totalSum"
                                    class="form-control parent-input">
                            </div>
                            <div class="col-md-4"><label class="form-label">{{ __('home.discount') }}
...
let rowIndex = 1;
    ...
    $("#updateinvoicebyidforsaleupdate").click(function(e) {
            ...
            var url = " {{ URL::to('update_deliverybyidforsaleupdate') }}" + "/" + $('#updateinvoicebyidforsale_update').val();
            console.log(url)
            jQuery.ajax({
                url: url,
                type: 'get',
...
function calculateTotals() {
    ...
    document.querySelectorAll('#productsTableBody tr').forEach(r => {
...

       {
        ...
        let totalRow = subtotal - discound ;
...
function calculateTotals_with_tax() {
    let total = 0,
        ...
        grand = 0;
    document.querySelectorAll('#productsTableBody tr').forEach(r => {
                let tax_with_price = parseFloat(r.querySelector('.product-price').value) || 0;

{
            
        let qty = parseFloat(r.querySelector('.product-quentity').value) || 0;
        let price =( tax_with_price);
