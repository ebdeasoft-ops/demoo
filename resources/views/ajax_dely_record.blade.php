...
<table class="table text-md-nowrap text-center  our-table" id="example2" width="100%"
    ...
    <tbody >
        ...
        @foreach ($data as $item)
             ...
             <td style="color:red">{{$item->debtor}}</td>
             <td style="color:red">{{$item->creditor}}</td>
        ...
        <td>
         ...
         <form action="{{ '/' . ($page = 'print_daily_record') }}" method="POST" role="search" autocomplete="off">
                                    ...
                                    <div class='col ' id="printdiv">
                                        ...
                                        <input type="number" class="form-control " name="record_id_print" id="record_id_print" value="{{ $item->dely_record}}" title=" رقم الفاتورة " readonly required hidden>
